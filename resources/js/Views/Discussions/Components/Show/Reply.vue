<template>
  <div class="flex-1 mb-2 border-b border-body-border">
    ...
    <div v-html="post.presented_body" class="p-6" v-if="!post.deleted_at" />
    <div class="p-6" v-else>
      <i class="mr-1 fas fa-times"></i> Ce message a été supprimé</div>
    </div>
</template>
...
import Quote from '@/Views/Discussions/Components/Show/Quote';

export default {
  components: { Popper, ActionButton, UserAvatar, UserName, Quote },
  props: ['post']
}
</script>