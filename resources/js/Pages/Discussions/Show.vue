                ...
                <div>
                  <inertia-link :href="route('users.show', post.user.name)">
                    <img
                      :src="post.user.avatar_url"
                      :alt="'Avatar de ' + post.user.display_name"
                      class="rounded inline sm:hidden wh-6 mt-1"
                    />
                  </inertia-link>

                  <i
                    v-if="post.user.id === discussion.user.id"
                    class="fas fa-crown text-muted"
                    :title="post.user.display_name + ' est l\'auteur de ce topic.'"
                  ></i>
                  <i
                    v-if="post.user.is_birthday"
                    class="fas fa-birthday-cake text-muted"
                    :title="'C\'est l\'anniversaire de ' + post.user.display_name + ', aujourd\'hui.'"
                  ></i>
                  <inertia-link :href="route('users.show', post.user.name)">
