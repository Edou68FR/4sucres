...
<form action="{{ route('admin.static-pages.update', $static_page) }}" method="post">
    <div class="card p-4 mb-4">
        ...
        <div class="mb-3">
            ...
            <input name="type" id="type" class="form-control w-full" value="{{ old('type', $static_page->type) }}">
            @if ($errors->has('type'))
                <div class="text-red-500 mb-3 text-xs font-bold">
                    {{ $errors->first('type') }}
                </div>
        ...
        <div class="mb-3">
            ...
            <input name="position" id="position" class="form-control w-full" value="{{ old('position', $static_page->position) }}">
